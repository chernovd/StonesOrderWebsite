<h1 class="main-headline">Order Overview</h1>
<?php
...
echo "</div>";
orderModal($DBConnect);

function getOrderCards($DBConnect)
{
    $selectProducts = "SELECT purchase_id, purchase_verificationNumber, purchase_isPaid FROM purchase WHERE purchase_status = 'pending' LIMIT  1";
